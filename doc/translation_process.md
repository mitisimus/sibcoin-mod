...
Multiple language support is critical in assisting Sibcoin’s global adoption, and growth. One of Sibcoin’s greatest strengths is cross-border money transfers, any help making that easier is greatly appreciated.
...
To automatically regenerate the `sibcoin_en.ts` file, run the following commands:
```sh
cd src/
make translate
```
...
You can find the Sibcoin translation project at [https://www.transifex.com/projects/p/dash/](https://www.transifex.com/projects/p/dash/).
...
2. Update `src/qt/sibcoin_locale.qrc` manually or via
...
To create a new language template, you will need to edit the languages manifest file `src/qt/sibcoin_locale.qrc` and add a new entry. Below is an example of the English language entry.

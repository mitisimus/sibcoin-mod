...
#define UNUSED
#endif
static const char UNUSED *sibcoin_strings[] = {
QT_TRANSLATE_NOOP("sibcoin-core", "Sibcoin Core"),
QT_TRANSLATE_NOOP("sibcoin-core", "The %s developers"),
...
QT_TRANSLATE_NOOP("sibcoin-core", ""
"Disable all Sibcoin specific functionality (Masternodes, PrivateSend, "
...
QT_TRANSLATE_NOOP("sibcoin-core", ""
"You are starting in lite mode, all Sibcoin-specific functionality is "
"disabled."),
QT_TRANSLATE_NOOP("sibcoin-core", ""
...
QT_TRANSLATE_NOOP("sibcoin-core", "%s corrupt, salvage failed"),
QT_TRANSLATE_NOOP("sibcoin-core", "%s is not a valid backup folder!"),
QT_TRANSLATE_NOOP("sibcoin-core", "%s is set very high!"),
QT_TRANSLATE_NOOP("sibcoin-core", "(%d could be used only on mainnet)"),
QT_TRANSLATE_NOOP("sibcoin-core", "(default: %s)"),
QT_TRANSLATE_NOOP("sibcoin-core", "(default: %u)"),
QT_TRANSLATE_NOOP("sibcoin-core", "(must be %d for mainnet)"),
QT_TRANSLATE_NOOP("sibcoin-core", "(press q to shutdown and continue later)"),
QT_TRANSLATE_NOOP("sibcoin-core", "-devnet can only be specified once"),
QT_TRANSLATE_NOOP("sibcoin-core", "-maxmempool must be at least %d MB"),
QT_TRANSLATE_NOOP("sibcoin-core", "-port must be specified when -devnet and -listen are specified"),
QT_TRANSLATE_NOOP("sibcoin-core", "-rpcport must be specified when -devnet and -server are specified"),
...
QT_TRANSLATE_NOOP("sibcoin-core", "Allow RFC1918 addresses to be relayed and connected to (default: %u)"),
...
QT_TRANSLATE_NOOP("sibcoin-core", "Append comment to the user agent string"),
QT_TRANSLATE_NOOP("sibcoin-core", "Attempt to recover private keys from a corrupt wallet on startup"),
QT_TRANSLATE_NOOP("sibcoin-core", "Automatic backups disabled"),
QT_TRANSLATE_NOOP("sibcoin-core", "Automatically create Tor hidden service (default: %d)"),
...
QT_TRANSLATE_NOOP("sibcoin-core", "Can't mix: no compatible inputs found!"),
QT_TRANSLATE_NOOP("sibcoin-core", "Cannot downgrade wallet"),
QT_TRANSLATE_NOOP("sibcoin-core", "Cannot resolve -%s address: '%s'"),
QT_TRANSLATE_NOOP("sibcoin-core", "Cannot write default address"),
QT_TRANSLATE_NOOP("sibcoin-core", "Change index out of range"),
...
QT_TRANSLATE_NOOP("sibcoin-core", "Copyright (C)"),
...
QT_TRANSLATE_NOOP("sibcoin-core", "ERROR! Failed to create automatic backup"),
QT_TRANSLATE_NOOP("sibcoin-core", "Enable publish hash block in <address>"),
QT_TRANSLATE_NOOP("sibcoin-core", "Enable publish hash transaction (locked via InstantSend) in <address>"),
QT_TRANSLATE_NOOP("sibcoin-core", "Enable publish hash transaction in <address>"),
QT_TRANSLATE_NOOP("sibcoin-core", "Enable publish raw block in <address>"),
QT_TRANSLATE_NOOP("sibcoin-core", "Enable publish raw transaction (locked via InstantSend) in <address>"),
QT_TRANSLATE_NOOP("sibcoin-core", "Enable publish raw transaction in <address>"),
QT_TRANSLATE_NOOP("sibcoin-core", "Enable the client to act as a masternode (0-1, default: %u)"),
QT_TRANSLATE_NOOP("sibcoin-core", "Enable transaction replacement in the memory pool (default: %u)"),
QT_TRANSLATE_NOOP("sibcoin-core", "Entries are full."),
QT_TRANSLATE_NOOP("sibcoin-core", "Entry exceeds maximum size."),
...
QT_TRANSLATE_NOOP("sibcoin-core", "Error loading %s"),
QT_TRANSLATE_NOOP("sibcoin-core", "Error loading %s: Wallet corrupted"),
QT_TRANSLATE_NOOP("sibcoin-core", "Error loading %s: Wallet requires newer version of %s"),
QT_TRANSLATE_NOOP("sibcoin-core", "Error loading %s: You can't disable HD on a already existing HD wallet"),
...
QT_TRANSLATE_NOOP("sibcoin-core", "Error upgrading chainstate database"),
QT_TRANSLATE_NOOP("sibcoin-core", "Error"),
QT_TRANSLATE_NOOP("sibcoin-core", "Error: A fatal internal error occurred, see debug.log for details"),
QT_TRANSLATE_NOOP("sibcoin-core", "Error: Disk space is low!"),
QT_TRANSLATE_NOOP("sibcoin-core", "Failed to create backup %s!"),
QT_TRANSLATE_NOOP("sibcoin-core", "Failed to create backup, error: %s"),
QT_TRANSLATE_NOOP("sibcoin-core", "Failed to delete backup, error: %s"),
QT_TRANSLATE_NOOP("sibcoin-core", "Failed to find mixing queue to join"),
QT_TRANSLATE_NOOP("sibcoin-core", "Failed to listen on any port. Use -listen=0 if you want this."),
QT_TRANSLATE_NOOP("sibcoin-core", "Failed to load fulfilled requests cache from"),
QT_TRANSLATE_NOOP("sibcoin-core", "Failed to load governance cache from"),
QT_TRANSLATE_NOOP("sibcoin-core", "Failed to load masternode cache from"),
QT_TRANSLATE_NOOP("sibcoin-core", "Failed to load masternode payments cache from"),
QT_TRANSLATE_NOOP("sibcoin-core", "Failed to parse host:port string"),
QT_TRANSLATE_NOOP("sibcoin-core", "Failed to start a new mixing queue"),
QT_TRANSLATE_NOOP("sibcoin-core", "Fee (in %s/kB) to add to transactions you send (default: %s)"),
...
QT_TRANSLATE_NOOP("sibcoin-core", "Imports blocks from external blk000??.dat file on startup"),
...
QT_TRANSLATE_NOOP("sibcoin-core", "Initialization sanity check failed. %s is shutting down."),
QT_TRANSLATE_NOOP("sibcoin-core", "Input is not valid."),
QT_TRANSLATE_NOOP("sibcoin-core", "InstantSend options:"),
...
QT_TRANSLATE_NOOP("sibcoin-core", "Invalid amount for -%s=<amount>: '%s'"),
QT_TRANSLATE_NOOP("sibcoin-core", "Invalid amount for -fallbackfee=<amount>: '%s'"),
QT_TRANSLATE_NOOP("sibcoin-core", "Invalid amount for -paytxfee=<amount>: '%s' (must be at least %s)"),
QT_TRANSLATE_NOOP("sibcoin-core", "Invalid input count."),
...
QT_TRANSLATE_NOOP("sibcoin-core", "Invalid spork address specified with -sporkaddr"),
...
QT_TRANSLATE_NOOP("sibcoin-core", "Keep N SIB anonymized (%u-%u, default: %u)"),
QT_TRANSLATE_NOOP("sibcoin-core", "Keep at most <n> unconnectable transactions in memory (default: %u)"),
QT_TRANSLATE_NOOP("sibcoin-core", "Keep the transaction memory pool below <n> megabytes (default: %u)"),
QT_TRANSLATE_NOOP("sibcoin-core", "Keypool ran out, please call keypoolrefill first"),
QT_TRANSLATE_NOOP("sibcoin-core", "Last PrivateSend was too recent."),
QT_TRANSLATE_NOOP("sibcoin-core", "Last successful PrivateSend action was too recent."),
...
QT_TRANSLATE_NOOP("sibcoin-core", "Loading banlist..."),
QT_TRANSLATE_NOOP("sibcoin-core", "Loading block index..."),
QT_TRANSLATE_NOOP("sibcoin-core", "Loading fulfilled requests cache..."),
QT_TRANSLATE_NOOP("sibcoin-core", "Loading governance cache..."),
QT_TRANSLATE_NOOP("sibcoin-core", "Loading masternode cache..."),
QT_TRANSLATE_NOOP("sibcoin-core", "Loading masternode payment cache..."),
QT_TRANSLATE_NOOP("sibcoin-core", "Loading wallet... (%3.2f %%)"),
QT_TRANSLATE_NOOP("sibcoin-core", "Loading wallet..."),
QT_TRANSLATE_NOOP("sibcoin-core", "Location of the auth cookie (default: data dir)"),
...
QT_TRANSLATE_NOOP("sibcoin-core", "Make the wallet broadcast transactions"),
QT_TRANSLATE_NOOP("sibcoin-core", "Masternode cache is empty, skipping payments and governance cache..."),
...
QT_TRANSLATE_NOOP("sibcoin-core", "Minimum bytes per sigop in transactions we relay and mine (default: %u)"),
QT_TRANSLATE_NOOP("sibcoin-core", "Missing input transaction information."),
QT_TRANSLATE_NOOP("sibcoin-core", "Mixing in progress..."),
QT_TRANSLATE_NOOP("sibcoin-core", "Mnemonic passphrase is too long, must be at most 256 characters"),
...
QT_TRANSLATE_NOOP("sibcoin-core", "No errors detected."),
...
QT_TRANSLATE_NOOP("sibcoin-core", "Not enough funds to anonymize."),
QT_TRANSLATE_NOOP("sibcoin-core", "Not in the Masternode list."),
QT_TRANSLATE_NOOP("sibcoin-core", "Number of automatic wallet backups (default: %u)"),
...
QT_TRANSLATE_NOOP("sibcoin-core", "Port: %d"),
QT_TRANSLATE_NOOP("sibcoin-core", "Prepend debug output with timestamp (default: %u)"),
QT_TRANSLATE_NOOP("sibcoin-core", "Print this help message and exit"),
QT_TRANSLATE_NOOP("sibcoin-core", "Print version and exit"),
QT_TRANSLATE_NOOP("sibcoin-core", "PrivateSend is idle."),
QT_TRANSLATE_NOOP("sibcoin-core", "PrivateSend options:"),
QT_TRANSLATE_NOOP("sibcoin-core", "PrivateSend request complete:"),
QT_TRANSLATE_NOOP("sibcoin-core", "PrivateSend request incomplete:"),
QT_TRANSLATE_NOOP("sibcoin-core", "Prune cannot be configured with a negative value."),
QT_TRANSLATE_NOOP("sibcoin-core", "Prune mode is incompatible with -txindex."),
QT_TRANSLATE_NOOP("sibcoin-core", "Pruning blockstore..."),
QT_TRANSLATE_NOOP("sibcoin-core", "RPC server options:"),
QT_TRANSLATE_NOOP("sibcoin-core", "Rebuild chain state and block index from the blk*.dat files on disk"),
QT_TRANSLATE_NOOP("sibcoin-core", "Rebuild chain state from the currently indexed blocks"),
QT_TRANSLATE_NOOP("sibcoin-core", "Receive and display P2P network alerts (default: %u)"),
QT_TRANSLATE_NOOP("sibcoin-core", "Reducing -maxconnections from %d to %d, because of system limitations."),
...
QT_TRANSLATE_NOOP("sibcoin-core", "Rescan the block chain for missing wallet transactions on startup"),
...
QT_TRANSLATE_NOOP("sibcoin-core", "Send trace/debug info to console instead of debug.log file"),
QT_TRANSLATE_NOOP("sibcoin-core", "Send trace/debug info to debug.log file (default: %u)"),
...
QT_TRANSLATE_NOOP("sibcoin-core", "Starting network threads..."),
...
QT_TRANSLATE_NOOP("sibcoin-core", "Synchroning blockchain..."),
QT_TRANSLATE_NOOP("sibcoin-core", "Synchronization failed"),
QT_TRANSLATE_NOOP("sibcoin-core", "Synchronization finished"),
QT_TRANSLATE_NOOP("sibcoin-core", "Synchronization pending..."),
QT_TRANSLATE_NOOP("sibcoin-core", "Synchronizing governance objects..."),
QT_TRANSLATE_NOOP("sibcoin-core", "Synchronizing masternode payments..."),
QT_TRANSLATE_NOOP("sibcoin-core", "Synchronizing masternodes..."),
QT_TRANSLATE_NOOP("sibcoin-core", "The source code is available from %s."),
QT_TRANSLATE_NOOP("sibcoin-core", "The transaction amount is too small to pay the fee"),
QT_TRANSLATE_NOOP("sibcoin-core", "The wallet will avoid paying less than the minimum relay fee."),
QT_TRANSLATE_NOOP("sibcoin-core", "This is experimental software."),
QT_TRANSLATE_NOOP("sibcoin-core", "This is not a Masternode."),
QT_TRANSLATE_NOOP("sibcoin-core", "This is the minimum transaction fee you pay on every transaction."),
QT_TRANSLATE_NOOP("sibcoin-core", "This is the transaction fee you will pay if you send a transaction."),
QT_TRANSLATE_NOOP("sibcoin-core", "Threshold for disconnecting misbehaving peers (default: %u)"),
QT_TRANSLATE_NOOP("sibcoin-core", "Too many %f denominations, removing."),
QT_TRANSLATE_NOOP("sibcoin-core", "Tor control port password (default: empty)"),
QT_TRANSLATE_NOOP("sibcoin-core", "Tor control port to use if onion listening enabled (default: %s)"),
QT_TRANSLATE_NOOP("sibcoin-core", "Transaction amount too small"),
QT_TRANSLATE_NOOP("sibcoin-core", "Transaction amounts must not be negative"),
...
QT_TRANSLATE_NOOP("sibcoin-core", "Transaction has too long of a mempool chain"),
QT_TRANSLATE_NOOP("sibcoin-core", "Transaction must have at least one recipient"),
...
QT_TRANSLATE_NOOP("sibcoin-core", "Trying to connect..."),
QT_TRANSLATE_NOOP("sibcoin-core", "Unable to bind to %s on this computer (bind returned error %s)"),
QT_TRANSLATE_NOOP("sibcoin-core", "Unable to bind to %s on this computer. %s is probably already running."),
QT_TRANSLATE_NOOP("sibcoin-core", "Unable to sign spork message, wrong key?"),
QT_TRANSLATE_NOOP("sibcoin-core", "Unable to start HTTP server. See debug log for details."),
QT_TRANSLATE_NOOP("sibcoin-core", "Unknown network specified in -onlynet: '%s'"),
QT_TRANSLATE_NOOP("sibcoin-core", "Unknown response."),
QT_TRANSLATE_NOOP("sibcoin-core", "Unknown state: id = %u"),
QT_TRANSLATE_NOOP("sibcoin-core", "Unsupported argument -benchmark ignored, use -debug=bench."),
QT_TRANSLATE_NOOP("sibcoin-core", "Unsupported argument -debugnet ignored, use -debug=net."),
QT_TRANSLATE_NOOP("sibcoin-core", "Unsupported argument -tor found, use -onion."),
QT_TRANSLATE_NOOP("sibcoin-core", "Upgrade wallet to latest format on startup"),
QT_TRANSLATE_NOOP("sibcoin-core", "Upgrading UTXO database"),
...
QT_TRANSLATE_NOOP("sibcoin-core", "User Agent comment (%s) contains unsafe characters."),
...
QT_TRANSLATE_NOOP("sibcoin-core", "Very low number of keys left: %d"),
QT_TRANSLATE_NOOP("sibcoin-core", "Wallet %s resides outside data directory %s"),
QT_TRANSLATE_NOOP("sibcoin-core", "Wallet debugging/testing options:"),
QT_TRANSLATE_NOOP("sibcoin-core", "Wallet is locked."),
QT_TRANSLATE_NOOP("sibcoin-core", "Wallet needed to be rewritten: restart %s to complete"),
...
QT_TRANSLATE_NOOP("sibcoin-core", "Warning: unknown new rules activated (versionbit %i)"),
QT_TRANSLATE_NOOP("sibcoin-core", "Wasn't able to create wallet backup folder %s!"),
QT_TRANSLATE_NOOP("sibcoin-core", "Whether to operate in a blocks only mode (default: %u)"),
QT_TRANSLATE_NOOP("sibcoin-core", "Will retry..."),
QT_TRANSLATE_NOOP("sibcoin-core", "You can not start a masternode in lite mode."),
...
QT_TRANSLATE_NOOP("sibcoin-core", "ZeroMQ notification options:"),
QT_TRANSLATE_NOOP("sibcoin-core", "no mixing available."),
QT_TRANSLATE_NOOP("sibcoin-core", "see debug.log for details."),
};

...
QT_TRANSLATE_NOOP("sibcoin-core", ""
"Listen for JSON-RPC connections on <port> (default: 1944 or testnet: 11944)"),
QT_TRANSLATE_NOOP("sibcoin-core", ""
...
"your clock is wrong Sibcoin will not work properly."),
QT_TRANSLATE_NOOP("sibcoin-core", ""
...
QT_TRANSLATE_NOOP("sibcoin-core", "(default: wallet.dat)"),
...
QT_TRANSLATE_NOOP("sibcoin-core", "Allow JSON-RPC connections from specified IP address"),
QT_TRANSLATE_NOOP("sibcoin-core", "Already have that input."),
QT_TRANSLATE_NOOP("sibcoin-core", "Always query for peer addresses via DNS lookup (default: 0)"),
...
QT_TRANSLATE_NOOP("sibcoin-core", "Clear list of wallet transactions (diagnostic tool; implies -rescan)"),
QT_TRANSLATE_NOOP("sibcoin-core", "Collateral is not valid."),
QT_TRANSLATE_NOOP("sibcoin-core", "Collateral not valid."),
QT_TRANSLATE_NOOP("sibcoin-core", "Connect only to the specified node(s)"),
QT_TRANSLATE_NOOP("sibcoin-core", "Connect through SOCKS proxy"),
QT_TRANSLATE_NOOP("sibcoin-core", "Connect to JSON-RPC on <port> (default: 1944 or testnet: 11944)"),
QT_TRANSLATE_NOOP("sibcoin-core", "Connect to KeePassHttp on port <port> (default: 19455)"),
...
QT_TRANSLATE_NOOP("sibcoin-core", "Darksend is disabled."),
QT_TRANSLATE_NOOP("sibcoin-core", "Darksend options:"),
QT_TRANSLATE_NOOP("sibcoin-core", "Debugging/Testing options:"),
QT_TRANSLATE_NOOP("sibcoin-core", "Disable safemode, override a real safe mode event (default: 0)"),
...
QT_TRANSLATE_NOOP("sibcoin-core", "Enable the client to act as a masternode (0-1, default: 0)"),
...
QT_TRANSLATE_NOOP("sibcoin-core", "Error loading wallet.dat: Wallet requires newer version of Sibcoin"),
...
QT_TRANSLATE_NOOP("sibcoin-core", "Error: system error: "),
QT_TRANSLATE_NOOP("sibcoin-core", "Failed to listen on any port. Use -listen=0 if you want this."),
QT_TRANSLATE_NOOP("sibcoin-core", "Failed to read block info"),
QT_TRANSLATE_NOOP("sibcoin-core", "Failed to read block"),
QT_TRANSLATE_NOOP("sibcoin-core", "Failed to sync block index"),
QT_TRANSLATE_NOOP("sibcoin-core", "Failed to write block index"),
QT_TRANSLATE_NOOP("sibcoin-core", "Failed to write block info"),
QT_TRANSLATE_NOOP("sibcoin-core", "Failed to write block"),
QT_TRANSLATE_NOOP("sibcoin-core", "Failed to write file info"),
QT_TRANSLATE_NOOP("sibcoin-core", "Failed to write to coin database"),
QT_TRANSLATE_NOOP("sibcoin-core", "Failed to write transaction index"),
QT_TRANSLATE_NOOP("sibcoin-core", "Failed to write undo data"),
QT_TRANSLATE_NOOP("sibcoin-core", "Fee per kB to add to transactions you send"),
QT_TRANSLATE_NOOP("sibcoin-core", "Fees smaller than this are considered zero fee (for relaying) (default:"),
QT_TRANSLATE_NOOP("sibcoin-core", "Force safe mode (default: 0)"),
QT_TRANSLATE_NOOP("sibcoin-core", "Generate coins (default: 0)"),
QT_TRANSLATE_NOOP("sibcoin-core", "Get help for a command"),
QT_TRANSLATE_NOOP("sibcoin-core", "How many blocks to check at startup (default: 288, 0 = all)"),
QT_TRANSLATE_NOOP("sibcoin-core", "If <category> is not supplied, output all debugging information."),
QT_TRANSLATE_NOOP("sibcoin-core", "Ignore masternodes less than version (example: 70050; default : 0)"),
...
QT_TRANSLATE_NOOP("sibcoin-core", "Invalid amount"),
...
QT_TRANSLATE_NOOP("sibcoin-core", "Keep N sibcoins anonymized (default: 0)"),
QT_TRANSLATE_NOOP("sibcoin-core", "Keep at most <n> unconnectable blocks in memory (default: %u)"),
...
QT_TRANSLATE_NOOP("sibcoin-core", "Limit size of signature cache to <n> entries (default: 50000)"),
QT_TRANSLATE_NOOP("sibcoin-core", "List commands"),
QT_TRANSLATE_NOOP("sibcoin-core", "Listen for connections on <port> (default: 1945 or testnet: 11945)"),
...
QT_TRANSLATE_NOOP("sibcoin-core", "Log transaction priority and fee per kB when mining blocks (default: 0)"),
QT_TRANSLATE_NOOP("sibcoin-core", "Maintain a full transaction index (default: 0)"),
QT_TRANSLATE_NOOP("sibcoin-core", "Maintain at most <n> connections to peers (default: 125)"),
...
QT_TRANSLATE_NOOP("sibcoin-core", "Maximum per-connection receive buffer, <n>*1000 bytes (default: 5000)"),
QT_TRANSLATE_NOOP("sibcoin-core", "Maximum per-connection send buffer, <n>*1000 bytes (default: 1000)"),
...
QT_TRANSLATE_NOOP("sibcoin-core", "Only accept block chain matching built-in checkpoints (default: 1)"),
QT_TRANSLATE_NOOP("sibcoin-core", "Only connect to nodes in network <net> (IPv4, IPv6 or Tor)"),
QT_TRANSLATE_NOOP("sibcoin-core", "Options:"),
QT_TRANSLATE_NOOP("sibcoin-core", "Password for JSON-RPC connections"),
QT_TRANSLATE_NOOP("sibcoin-core", "Prepend debug output with timestamp (default: 1)"),
QT_TRANSLATE_NOOP("sibcoin-core", "Print block on startup, if found in block index"),
QT_TRANSLATE_NOOP("sibcoin-core", "Print block tree on startup (default: 0)"),
QT_TRANSLATE_NOOP("sibcoin-core", "RPC SSL options: (see the Bitcoin Wiki for SSL setup instructions)"),
QT_TRANSLATE_NOOP("sibcoin-core", "RPC client options:"),
...
QT_TRANSLATE_NOOP("sibcoin-core", "Run a thread to flush wallet periodically (default: 1)"),
QT_TRANSLATE_NOOP("sibcoin-core", "Run in the background as a daemon and accept commands"),
QT_TRANSLATE_NOOP("sibcoin-core", "SSL options: (see the Bitcoin Wiki for SSL setup instructions)"),
QT_TRANSLATE_NOOP("sibcoin-core", "Select SOCKS version for -proxy (4 or 5, default: 5)"),
QT_TRANSLATE_NOOP("sibcoin-core", "Send command to Sibcoin Core"),
QT_TRANSLATE_NOOP("sibcoin-core", "Send commands to node running on <ip> (default: 127.0.0.1)"),
QT_TRANSLATE_NOOP("sibcoin-core", "Send trace/debug info to console instead of debug.log file"),
QT_TRANSLATE_NOOP("sibcoin-core", "Server certificate file (default: server.cert)"),
QT_TRANSLATE_NOOP("sibcoin-core", "Server private key (default: server.pem)"),
QT_TRANSLATE_NOOP("sibcoin-core", "Session not complete!"),
QT_TRANSLATE_NOOP("sibcoin-core", "Session timed out, please resubmit."),
QT_TRANSLATE_NOOP("sibcoin-core", "Set database cache size in megabytes (%d to %d, default: %d)"),
QT_TRANSLATE_NOOP("sibcoin-core", "Set key pool size to <n> (default: 1000)"),
QT_TRANSLATE_NOOP("sibcoin-core", "Set maximum block size in bytes (default: %d)"),
QT_TRANSLATE_NOOP("sibcoin-core", "Set minimum block size in bytes (default: 0)"),
QT_TRANSLATE_NOOP("sibcoin-core", "Set the masternode private key"),
QT_TRANSLATE_NOOP("sibcoin-core", "Set the number of threads to service RPC calls (default: 4)"),
QT_TRANSLATE_NOOP("sibcoin-core", "Sets the DB_PRIVATE flag in the wallet db environment (default: 1)"),
QT_TRANSLATE_NOOP("sibcoin-core", "Show all debugging options (usage: --help -help-debug)"),
QT_TRANSLATE_NOOP("sibcoin-core", "Show benchmark information (default: 0)"),
QT_TRANSLATE_NOOP("sibcoin-core", "Shrink debug.log file on client startup (default: 1 when no -debug)"),
QT_TRANSLATE_NOOP("sibcoin-core", "Sibcoin Core Daemon"),
QT_TRANSLATE_NOOP("sibcoin-core", "Sibcoin Core RPC client version"),
QT_TRANSLATE_NOOP("sibcoin-core", "Signing failed."),
QT_TRANSLATE_NOOP("sibcoin-core", "Signing timed out, please resubmit."),
QT_TRANSLATE_NOOP("sibcoin-core", "Signing transaction failed"),
QT_TRANSLATE_NOOP("sibcoin-core", "Specify configuration file (default: sibcoin.conf)"),
QT_TRANSLATE_NOOP("sibcoin-core", "Specify connection timeout in milliseconds (default: 5000)"),
QT_TRANSLATE_NOOP("sibcoin-core", "Specify data directory"),
QT_TRANSLATE_NOOP("sibcoin-core", "Specify masternode configuration file (default: masternode.conf)"),
QT_TRANSLATE_NOOP("sibcoin-core", "Specify pid file (default: sibcoind.pid)"),
...
QT_TRANSLATE_NOOP("sibcoin-core", "Spend unconfirmed change when sending transactions (default: 1)"),
QT_TRANSLATE_NOOP("sibcoin-core", "Start Sibcoin Core Daemon"),
QT_TRANSLATE_NOOP("sibcoin-core", "System error: "),
...
QT_TRANSLATE_NOOP("sibcoin-core", "Threshold for disconnecting misbehaving peers (default: 100)"),
QT_TRANSLATE_NOOP("sibcoin-core", "To use the %s option"),
...
QT_TRANSLATE_NOOP("sibcoin-core", "Unable to sign masternode payment winner, wrong key?"),
QT_TRANSLATE_NOOP("sibcoin-core", "Unable to sign spork message, wrong key?"),
QT_TRANSLATE_NOOP("sibcoin-core", "Unknown -socks proxy version requested: %i"),
...
QT_TRANSLATE_NOOP("sibcoin-core", "Usage (deprecated, use sibcoin-cli):"),
QT_TRANSLATE_NOOP("sibcoin-core", "Usage:"),
QT_TRANSLATE_NOOP("sibcoin-core", "Use KeePass 2 integration using KeePassHttp plugin (default: 0)"),
QT_TRANSLATE_NOOP("sibcoin-core", "Use N separate masternodes to anonymize funds  (2-8, default: 2)"),
QT_TRANSLATE_NOOP("sibcoin-core", "Use OpenSSL (https) for JSON-RPC connections"),
QT_TRANSLATE_NOOP("sibcoin-core", "Use UPnP to map the listening port (default: 0)"),
...
QT_TRANSLATE_NOOP("sibcoin-core", "Wait for RPC server to start"),
QT_TRANSLATE_NOOP("sibcoin-core", "Wallet %s resides outside data directory %s"),
QT_TRANSLATE_NOOP("sibcoin-core", "Wallet is locked."),
QT_TRANSLATE_NOOP("sibcoin-core", "Wallet needed to be rewritten: restart Sibcoin to complete"),
QT_TRANSLATE_NOOP("sibcoin-core", "Wallet options:"),
QT_TRANSLATE_NOOP("sibcoin-core", "Warning"),
QT_TRANSLATE_NOOP("sibcoin-core", "Warning: Deprecated argument -debugnet ignored, use -debug=net"),
...
QT_TRANSLATE_NOOP("sibcoin-core", "version"),
